...
for _path in (_TRAINING_DIR, _SHARED_TRAINING_DIR):
...
_VENDOR_CONFIG_DIR = str(_REPO_ROOT / "vendor" / "starcop" / "scripts" / "configs")
_OVERLAY_PATH = _REPO_ROOT / "configs" / "training" / "overlay.yaml"
