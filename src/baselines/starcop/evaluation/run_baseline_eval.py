...
unit test, following the same pattern as baseline training's untested
`starcop_datamodule.py` glue.
"""
...
sys.path.insert(0, str(_SRC_DIR / "registry"))
sys.path.insert(0, str(_SRC_DIR / "baselines" / "starcop" / "registry"))
