"""Tests for src/baselines/starcop/serving/inference.py -- pure tensor-assembly and inference
...
class TestPerBandMeans:
    ...
    (src/baselines/starcop/serving/service.py) -- each request contributes one mean-per-band
...
class TestHasPlume:
    ...
    counter (src/baselines/starcop/serving/service.py) -- BentoML's own built-in metrics have
