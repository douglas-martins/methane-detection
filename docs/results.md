...
- **AUPRC** — a single score summarizing how well the model ranks real
...
| `mag1c + rgb` | ✅ passed |
| `mag1c only` | ✅ passed |
| MultiSTARCOP (Varon) | — out of scope, not deployed live |
...
*Last updated 2026-08-22. Full evaluation and live-check run:
[track-a-paper-benchmark-reproduction-plan.md](https://github.com/douglas-martins/methane-detection/blob/main/internal-docs/plans/track-a-paper-benchmark-reproduction-plan.md).
MLflow run IDs — `mag1c + rgb`: `0116dc444ad941dbb74c98a318bd1e93`,
`mag1c only`: `ddf8d8e44d614371a3d5b386c18efbaa`,
MultiSTARCOP (Varon): `b2a1f6cd8a4d4a11b22e97ceaf378933`.*
