...
<!-- Commands you ran, e.g. `make test-research`, `make lint`. Prefer real fixtures over broad mocking -- see CONTRIBUTING.md. -->
...
- [ ] Relevant tests pass locally (`make test-baseline` and/or `make test-research`).
